...
private let logger = Logger(subsystem: "com.constellate", category: "NotificationService")
...
final class NotificationService: NSObject {
    ...
    enum NotificationID {
        static let morningCheckin = "constellate.morning.checkin"
        static let eveningReview = "constellate.evening.review"
    }
