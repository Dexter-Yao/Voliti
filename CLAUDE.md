...
- `DESIGN.md` — **Starpath Protocol v2 设计系统规范**（所有视觉决策的唯一来源）
- `docs/02_Design_System.md` — 设计系统历史文档（Starpath v1，已被 DESIGN.md 取代）
- `docs/design-system/design-tokens.json` — 设计 tokens（待更新对齐 v2）
- `docs/design-system/component-rules.json` — 组件渲染规则（待更新对齐 v2）
