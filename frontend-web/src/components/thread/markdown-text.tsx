...
const CodeHeader: FC<CodeHeaderProps> = ({ language, code }) => {
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-t-lg bg-[#1A1816] px-4 py-2 text-sm font-semibold text-[#F4F0E8]">
...
const defaultComponents: any = {
  ...
  pre: ({ className, ...props }: { className?: string }) => (
    <pre
      className={cn(
        "max-w-4xl overflow-x-auto rounded-lg bg-[#1A1816] text-[#F4F0E8]",
        className,
      )}
      {...props}
    />
